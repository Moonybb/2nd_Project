			...
			<div>
				...
				<div id="btn">
					<input type="hidden"  id="isManager" value="<c:out value="${level }"/>">
				 	<button id="modyfy" type = "button" onclick ="location.href='stuEmployModify.jb?stuEmployNum=${bean.stuEmployNum }'" name='btns'>수정</button>
					<button id="delete" type = "button" onclick ="location.href='stuEmployDelete.jb?stuEmployNum=${bean.stuEmployNum }'" name='btns'>삭제</button>
